...
func _initialize() -> void:
	...
	# 追加 ext_resource（CharacterManager 脚本、注册表、控制器脚本、HUD）
...
[ext_resource type="Script" path="res://scripts/character_switch_controller.gd" id="ctl_script"]
...
[node name="CharacterSwitchController" type="Node" parent="."]
script = ExtResource("ctl_script")
